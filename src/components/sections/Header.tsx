...
const Header: React.FC = () => {
  ...
  return (
    <header className="flex flex-col items-center justify-center gap-5 px-6 py-12 md:flex-row md:py-16">
      {/* Avatar */}
      <div className="relative grid place-content-center w-full max-w-[220px] md:max-w-[300px] h-auto overflow-hidden rounded-full shadow-[0_0_40px_#0007] z-[1]">
        <img
          src="/images/avatar.webp"
          alt="Imagen de perfil de Giancarlo"
          className="w-full h-full object-cover rounded-full z-[3]"
        />
        <div className="absolute inset-0 animate-spin bg-gradient-to-r from-yellow-400 to-blue-500 opacity-50 z-[2]" />
      </div>
